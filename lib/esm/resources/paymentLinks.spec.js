...
test('client.paymentLinks.cancel', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
test('client.paymentLinks.create', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
test('client.paymentLinks.all', () => runTest(merge(findOptions, {
    subject: client => client.paymentLinks.all({ count: 10, page: 2 }),
    url: '/payment_links',
})));
//# sourceMappingURL=paymentLinks.spec.js.map