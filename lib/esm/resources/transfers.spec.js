...
test('client.transfers.all', () => runTest(merge(findOptions, {
    subject: client => client.transfers.all({ count: 10, page: 2 }),
    url: '/transfers',
})));
test('client.transfers.create', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
test('client.transfers.cancel', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
test('client.transfers.days', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
test('client.transfers.limits', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
test('client.transfers.limits with recipient_id', () => runTest({
    connect: {
        api_key: 'abc123',
    },
