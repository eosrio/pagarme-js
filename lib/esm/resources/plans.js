...
const findOne = curry((opts, body) => request.get(opts, routes.plans.details(body.id), {}));
const findAll = curry((opts, pagination) => request.get(opts, routes.plans.base, pagination || {}));
/**
 * `GET /plans`
 ...
 */
const create = (opts, body) => request.post(opts, routes.plans.base, body);
/**
 * `PUT /plans/:id`
 ...
 *                    data or to an error.
 */
const update = (opts, body) => request.put(opts, routes.plans.details(body.id), body);
export default {
    all,
    find,
    findAll,
