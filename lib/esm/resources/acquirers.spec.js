...
test('client.acquirers.all', () => runTest(merge(findOptions, {
    subject: client => client.acquirers.all({ count: 10, page: 2 }),
    url: '/acquirers',
})));
test('client.acquirers.create', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
test('client.acquirers.update', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
test('client.acquirers.updateAnticipationDelay', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
//# sourceMappingURL=acquirers.spec.js.map