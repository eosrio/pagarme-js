...
test('client.bulkAnticipations.create', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
test('client.bulkAnticipations.update', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
test('client.bulkAnticipations.destroy', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
test('client.bulkAnticipations.limits', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
test('client.bulkAnticipations.days', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
test('client.bulkAnticipations.confirm', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
test('client.bulkAnticipations.cancel', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
//# sourceMappingURL=bulkAnticipations.spec.js.map