...
const findOne = curry((opts, body) => request.get(opts, routes.transfers.details(body.id), {}));
const findAll = curry((opts, pagination) => request.get(opts, routes.transfers.base, pagination || {}));
/**
 * `GET /transfers`
 ...
 */
const create = (opts, body) => request.post(opts, routes.transfers.base, body);
/**
 ...
 *                    the request or to an error.
 */
const cancel = (opts, body) => request.post(opts, routes.transfers.cancel(body.id), {});
/**
 * `GET /transfers/days`
 ...
 *                      by `connect` functions.
*/
const days = opts => request.get(opts, routes.transfers.days, {});
/**
 ...
 *
*/
const limits = (opts, params) => request.get(opts, routes.transfers.limits, params);
export default {
    find,
    all,
    create,
