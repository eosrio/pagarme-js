 ...
 */
const create = (opts, email, password, recaptchaToken, token) => request.post(opts, routes.session.base, {
    email,
    password,
    recaptchaToken,
    token,
 ...
 *                    the request or to an error.
 */
const destroy = (opts, id) => request.delete(opts, routes.session.destroy(id), {});
/**
 ...
 *                    the request or to an error.
 */
const verify = (opts, payload) => request.post(opts, routes.session.verify(payload.id), payload);
export default {
    create,
    destroy,
    verify,
