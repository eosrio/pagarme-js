...
test('client.subscriptions.all', () => runTest(merge(findOptions, {
    subject: client => client.subscriptions.all({ count: 10, page: 2 }),
    url: '/subscriptions',
})));
test('client.subscriptions.create', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
test('client.subscriptions.update', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
test('client.subscriptions.cancel', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
test('client.subscriptions.createTransaction', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
test('client.subscriptions.findTransactions', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
test('client.subscriptions.settleCharge', () => runTest({
    connect: {
        api_key: 'abc123',
    },
