 ...
 */
const create = (opts, body) => request.post(opts, routes.onboardingAnswers.base, body);
/**
 ...
 *                    the request or to an error.
 */
const all = (opts, body) => request.get(opts, routes.onboardingAnswers.base, body);
/**
 ...
 *                    the request or to an error.
 */
const destroy = (opts, body) => request.delete(opts, routes.onboardingAnswers.base, body);
export default {
    all,
    create,
    destroy,
};
//# sourceMappingURL=onboardingAnswers.js.map