 ...
 */
const all = (opts, body) => request.get(opts, routes.settlements.all(body.recipientId), body);
/**
 ...
 *                    the request or to an error.
 */
const contractsAll = (opts, body) => request.get(opts, routes.settlements.contracts.all(body.recipientId), body);
export default {
    all,
    contracts: {
        all: contractsAll,
