...
const findOne = curry((opts, body) => request.get(opts, routes.acquirersConfigurations.details(body.id), {}));
const findAll = curry((opts, pagination) => request.get(opts, routes.acquirersConfigurations.base, pagination || {}));
/**
 ...
 */
const create = (opts, body) => request.post(opts, routes.acquirersConfigurations.base, body);
/**
 ...
 *                    data or to an error.
 */
const update = (opts, body) => request.put(opts, routes.acquirersConfigurations.details(body.id), body);
export default {
    all,
    find,
    findAll,
...
//# sourceMappingURL=acquirersConfigurations.js.map