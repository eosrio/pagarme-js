...
const findOne = curry((opts, body) => request.get(opts, routes.invites.details(body.id), {}));
const findAll = opts => request.get(opts, routes.invites.base, {});
/**
 * `GET /invites`
 ...
 */
const create = (opts, body) => request.post(opts, routes.invites.base, body);
/**
 * `DELETE /invites`
 ...
 *                    the request or to an error.
 */
const destroy = (opts, body) => request.delete(opts, routes.invites.details(body.id), {});
export default {
    find,
    all,
    create,
