 ...
 **/
import { both, cond, curry, has, omit, } from 'ramda';
import * as routes from '../routes';
import request from '../request';
const findAll = curry((opts, body) => request.get(opts, routes.antifraudAnalyses.findAll(body.transactionId), {}));
...
const create = (opts, body) => {
    ...
    return request.post(opts, routes.antifraudAnalyses.create(transactionId), omit(['transactionId'], body));
};
export default {
    find,
    create,
};
//# sourceMappingURL=antifraudAnalyses.js.map