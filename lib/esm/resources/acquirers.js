...
const findOne = curry((opts, body) => request.get(opts, routes.acquirers.details(body.id), {}));
const findAll = curry((opts, pagination) => request.get(opts, routes.acquirers.base, pagination || {}));
/**
 * `GET /acquirers`
 ...
 */
const create = (opts, body) => request.post(opts, routes.acquirers.base, body);
/**
 * `PUT /acquirers/:id`
 ...
 *                    data or to an error.
 */
const update = (opts, body) => request.put(opts, routes.acquirers.details(body.id), body);
/**
 ...
 *                    data or to an error.
 */
const updateAnticipationDelay = (opts, body) => request.put(opts, routes.acquirers.anticipation(body.id, body.delay), body);
export default {
    all,
    find,
    findAll,
...
//# sourceMappingURL=acquirers.js.map