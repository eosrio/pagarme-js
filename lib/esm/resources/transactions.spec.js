...
test('client.transaction.capture', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
test('client.transactions.cardHashKey', () => runTest({
    connect: {
...
test('client.transactions.collectPayment', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
test('client.transactions.create', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
test('client.transactions.all', () => runTest(merge(findOptions, {
    subject: client => client.transactions.all({ count: 10, page: 2 }),
    url: '/transactions',
})));
test('client.transactions.refund', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
test('client.transactions.update', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
test('client.transactions.calculateInstallmentsAmount', () => runTest({
    connect: {
        api_key: 'abc123',
    },
