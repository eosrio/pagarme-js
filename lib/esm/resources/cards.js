...
const findOne = curry((opts, body) => request.get(opts, routes.cards.details(body.id), {}));
const findAll = curry((opts, pagination) => request.get(opts, routes.cards.base, pagination || {}));
/**
 * `GET /cards`
 ...
 */
const create = (opts, body) => request.post(opts, routes.cards.base, body);
export default {
    find,
    all,
    create,
