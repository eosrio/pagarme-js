...
const findOne = curry((opts, body) => request.get(opts, routes.subscriptions.details(body.id), {}));
const findAll = curry((opts, pagination) => request.get(opts, routes.subscriptions.base, pagination || {}));
/**
 * `GET /subscriptions`
 ...
 */
const create = (opts, body) => request.post(opts, routes.subscriptions.base, body);
/**
 ...
 *                    data or to an error.
 */
const update = (opts, body) => request.put(opts, routes.subscriptions.details(body.id), body);
/**
 ...
 *                    the request or to an error.
 */
const cancel = (opts, body) => request.post(opts, routes.subscriptions.cancel(body.id), {});
/**
 ...
 *                    the request or to an error.
 */
const createTransaction = (opts, body) => request.post(opts, routes.subscriptions.transactions(body.id), body);
/**
 ...
 *                    the request or to an error.
 */
const findTransactions = (opts, body) => request.get(opts, routes.subscriptions.transactions(body.id), body);
/**
 ...
 *                    body or to an error.
 */
const settleCharge = (opts, body) => request.post(opts, routes.subscriptions.settleCharge(body.id), body);
export default {
    all,
    find,
    findAll,
