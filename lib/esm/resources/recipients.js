...
const findOne = curry((opts, body) => request.get(opts, routes.recipients.details(body.id), {}));
const findAll = curry((opts, pagination) => request.get(opts, routes.recipients.base, pagination || {}));
/**
 * `GET /recipients`
 ...
 *                    the request or to an error.
 */
const update = (opts, body) => request.put(opts, routes.recipients.details(body.id), body);
export default {
    find,
    all,
    create,
