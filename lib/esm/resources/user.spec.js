...
test('client.user.create', () => runTest({
    connect: {
        api_key: 'foobar',
    },
...
test('client.user.redefinePassword', () => runTest({
    connect: {
        api_key: 'foobar',
    },
...
test('client.user.resetPassword', () => runTest({
    connect: {
        api_key: 'foobar',
    },
...
test('client.user.all', () => runTest(merge(findOptions, {
    subject: client => client.user.all({ count: 10, page: 2 }),
    url: '/users',
})));
test('client.user.destroy', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
test('client.user.update', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
test('client.user.updatePassword', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
test('client.transactions.current', () => runTest(merge(findOptions, {
