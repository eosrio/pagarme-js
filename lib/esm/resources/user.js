...
const findOne = curry((opts, body) => request.get(opts, routes.user.details(body.id), {}));
const findAll = curry((opts, pagination) => request.get(opts, routes.user.base, pagination || {}));
/**
 * `GET /users`
 ...
 */
const resetPassword = (opts, body) => request.put(opts, routes.user.resetPassword, body);
/**
 ...
 *                    of the request or an error.
 */
const redefinePassword = (opts, body) => request.put(opts, routes.user.redefinePassword, body);
/**
 * `POST /users/`
 * Creates a user
 *
 ...
 * @param {Object} body The payload for the request.
 */
const create = (opts, body) => request.post(opts, routes.user.base, body);
/**
 * `GET /users`
 ...
 */
const destroy = (opts, body) => request.delete(opts, routes.user.details(body.id), {});
/**
 * `PUT /users/:id`
 ...
 *                    data or to an error.
 **/
const update = (opts, body) => request.put(opts, routes.user.details(body.id), body);
/**
 ...
 *                    data or to an error.
 **/
const updatePassword = (opts, body) => request.put(opts, routes.user.updatePassword(body.id), body);
/**
 * `GET /user`
 ...
 *                    data or to an error.
 */
const current = opts => request.get(opts, routes.user.singular, {});
export default {
    all,
    create,
    current,
