...
const findAllInTransactions = curry((opts, body) => request.get(opts, routes.postbacks.transaction(body.transactionId), {}));
const findOneInTransactions = curry((opts, body) => request.get(opts, routes.postbacks.transactionDetails(body.id, body.transactionId), {}));
const findAllInSubscriptions = curry((opts, body) => request.get(opts, routes.postbacks.subscription(body.subscriptionId), {}));
/**
 ...
 * @param {Number} body.subscriptionId A subscription ID
*/
const redeliver = (opts, body) => request.post(opts, routes.postbacks.redeliver(body.subscriptionId, body.id), {});
export default {
    find,
    redeliver,
};
