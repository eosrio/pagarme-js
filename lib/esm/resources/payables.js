...
const findTransaction = curry((opts, body) => request.get(opts, routes.payables.transaction(body.transactionId), {}));
const findOne = curry((opts, body) => request.get(opts, routes.payables.find(body.id), {}));
const findAll = curry((opts, pagination) => request.get(opts, routes.payables.base, pagination));
/**
 * `GET /payables`
 ...
 * @param body
 */
const days = (opts, body) => request.get(opts, routes.payables.days, body);
export default {
    find,
    all,
    days,
