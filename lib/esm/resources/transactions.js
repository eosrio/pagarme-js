...
const findOne = curry((opts, body) => request.get(opts, routes.transactions.details(body.id), {}));
const findAll = curry((opts, pagination) => request.get(opts, routes.transactions.base, pagination || {}));
/**
 * `GET /transactions`
 ...
 */
const create = (opts, body) => request.post(opts, routes.transactions.base, body);
/**
 ...
 *                    the request or to an error.
 */
const capture = (opts, body) => request.post(opts, routes.transactions.capture(body.id), body);
/**
 ...
 *                    the request or to an error.
 */
const refund = (opts, body) => request.post(opts, routes.transactions.refund(body.id), body);
/**
 ...
 *                    the request or to an error.
 */
const collectPayment = (opts, body) => request.post(opts, routes.transactions.collectPayment(body.id), body);
/**
 ...
 *                      the request or to an error.
 */
const cardHashKey = opts => request.get(opts, routes.transactions.cardHashKey, {});
/**
 * `PUT /transactions/:id`
 ...
 *                    data or to an error.
 **/
const update = (opts, body) => request.put(opts, routes.transactions.details(body.id), body);
/**
 ...
 *                    the request or to an error.
 */
const calculateInstallmentsAmount = (opts, body) => request.get(opts, routes.transactions.calculateInstallmentsAmount, body);
/**
...
const reprocess = (opts, body) => {
    ...
    return request.post(opts, routes.transactions.reprocess(body.id), payload);
};
export default {
    find,
    all,
