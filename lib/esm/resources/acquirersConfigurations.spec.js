...
test('client.acquirersConfigurations.all', () => runTest(merge(findOptions, {
    subject: client => client.acquirersConfigurations.all({ count: 10, page: 2 }),
    url: '/acquirers_configurations',
})));
test('client.acquirersConfigurations.create', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
test('client.acquirersConfigurations.update', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
//# sourceMappingURL=acquirersConfigurations.spec.js.map