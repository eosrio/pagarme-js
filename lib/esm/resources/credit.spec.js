...
test('client.credit.creditLines.all', () => runTest(merge(findOptions, {
    subject: client => client.credit.creditLines.all(),
    url: '/credit/credit_lines',
})));
test('client.credit.proposals.findOne', () => runTest(merge(findOptions, {
...
test('client.credit.proposals.create', () => runTest(merge(findOptions, {
...
test('client.credit.proposals.accept', () => runTest(merge(findOptions, {
...
test('client.credit.proposals.settlementForecast', () => runTest(merge(findOptions, {
...
test('client.credit.loans.find', () => runTest(merge(findOptions, {
    subject: client => client.credit.loans.find({
        loanId: '123',
    }),
    url: '/credit/loans/123',
})));
test('client.credit.statements.findDaily', () => runTest(merge(findOptions, {
...
test('client.credit.statements.findMonthly', () => runTest(merge(findOptions, {
