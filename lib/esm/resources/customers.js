...
const findOne = curry((opts, body) => request.get(opts, routes.customers.details(body.id), {}));
const findAll = curry((opts, pagination) => request.get(opts, routes.customers.base, pagination || {}));
/**
 * `GET /customers`
 ...
 */
const create = (opts, body) => request.post(opts, routes.customers.base, body);
export default {
    find,
    all,
    create,
