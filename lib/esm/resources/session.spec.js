...
test('client.session.create', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
test('client.session.create.recaptchaToken', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
test('client.session.verify', () => runTest({
    connect: {
        api_key: 'abc123',
    },
...
test('client.session.destroy', () => runTest({
    connect: {
        api_key: 'abc123',
    },
