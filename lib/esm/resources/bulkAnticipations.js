 ...
 **/
import { T, cond, curry, dissoc, has, } from 'ramda';
import * as routes from '../routes';
import request from '../request';
const findOne = curry((opts, body) => request.get(opts, routes.bulkAnticipations.details(body.recipientId, body.id), {}));
const findAll = curry((opts, body) => request.get(opts, routes.bulkAnticipations.base(body.recipientId), dissoc('recipientId', body)));
/**
 ...
 */
const create = (opts, body) => request.post(opts, routes.bulkAnticipations.base(body.recipientId), body);
/**
 ...
 *                    the request or to an error.
 */
const update = (opts, body) => request.put(opts, routes.bulkAnticipations.details(body.recipientId, body.id), body);
/**
 ...
 *                    the request or to an error.
 */
const destroy = (opts, body) => request.delete(opts, routes.bulkAnticipations.details(body.recipientId, body.id), body);
/**
 ...
 *                    the request or to an error.
 */
const limits = (opts, body) => request.get(opts, routes.bulkAnticipations.limits(body.recipientId), dissoc('recipientId', body));
/**
 ...
 *                    the request or to an error.
 */
const days = (opts, body) => request.get(opts, routes.bulkAnticipations.days(body.recipientId, body.id), body);
/**
 ...
 *                    the request or to an error.
 */
const confirm = (opts, body) => request.post(opts, routes.bulkAnticipations.confirm(body.recipientId, body.id), body);
/**
 ...
 *                    the request or to an error.
 */
const cancel = (opts, body) => request.post(opts, routes.bulkAnticipations.cancel(body.recipientId, body.id), body);
export default {
    find,
    all,
    create,
...
//# sourceMappingURL=bulkAnticipations.js.map