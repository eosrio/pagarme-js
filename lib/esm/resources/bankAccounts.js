...
const findOne = curry((opts, body) => request.get(opts, routes.bankAccounts.details(body.id), {}));
const findAll = curry((opts, pagination) => request.get(opts, routes.bankAccounts.base, pagination || {}));
/**
 * `GET /bank_accounts`
 ...
 */
const create = (opts, body) => request.post(opts, routes.bankAccounts.base, body);
export default {
    all,
    create,
    find,
