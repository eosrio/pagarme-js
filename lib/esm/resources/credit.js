 ...
 */
const findAllCreditLines = opts => request.get(opts, routes.credit.creditLines.all);
/**
 ...
 *                    the request or to an error.
 */
const findOneProposal = (opts, body) => request.get(opts, routes.credit.proposals.details(body.creditLineId, body.proposalId));
/**
 ...
 *                    the request or to an error.
 */
const createProposal = (opts, body) => request.post(opts, routes.credit.proposals.create(body.creditLineId), body);
/**
 ...
 *                    the request or to an error.
 */
const acceptProposal = (opts, body) => request.post(opts, routes.credit.proposals.accept(body.creditLineId, body.proposalId), body);
/**
 ...
 *                    the request or to an error.
 */
const settlementForecast = (opts, body) => request.get(opts, routes.credit.proposals
 ...
 *                    the request or to an error.
 */
const findAllLoans = curry(opts => request.get(opts, routes.credit.loans.all));
/**
 ...
 *                    the request or to an error.
 */
const findOneLoan = curry((opts, body) => request.get(opts, routes.credit.loans.details(body.loanId), body));
/**
 ...
 *                    the request or to an error.
 */
const findLoans = (opts, body) => cond([
 ...
 *                    the request or to an error.
 */
const dailyStatement = (opts, body) => request.get(opts, routes.credit.statements.daily(body.loanId), body);
/**
 ...
 *                    the request or to an error.
 */
const monthlyStatement = (opts, body) => request.get(opts, routes.credit.statements.monthly(body.loanId), body);
export default {
    creditLines: {
