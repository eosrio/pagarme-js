...
const findAllInTransactions = curry((opts, body) => request.get(opts, routes.gatewayOperations.transaction(body.transactionId), {}));
const findOneInTransactions = curry((opts, body) => request.get(opts, routes.gatewayOperations.transactionDetails(body.id, body.transactionId), {}));
const findAllInSubscriptions = curry((opts, body) => request.get(opts, routes.gatewayOperations.subscription(body.subscriptionId), {}));
/**
 ...
 * @param {Number} [body.subscriptionId] A subscription ID
*/
const refuseMessage = (opts, body) => request.get(opts, routes.gatewayOperations.refuseMessage(body.subscriptionId, body.id), {});
export default {
    find,
    refuseMessage,
};
//# sourceMappingURL=gatewayOperations.js.map