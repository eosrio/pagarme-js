...
const buildSessionAuth = ({ session_id: sessionId, impersonation_key: impersonationKey, }, options) => mergeRight(options, {
    body: {
 ...
 * @private
 */
function execute({ email, password, recaptchaToken, token, impersonationKey, environment, options, }) {
